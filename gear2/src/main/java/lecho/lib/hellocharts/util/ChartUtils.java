...
public abstract class ChartUtils {
    ...
    public static final int COLOR_6 = Color.parseColor("#0000EE");
    public static final int COLOR_7 = Color.parseColor("#8B5742");
    public static final int COLOR_8 = Color.parseColor("#6B8E23");
    public static final int COLOR_9 = Color.parseColor("#CDC9A5");
    public static final int COLOR_10 = Color.parseColor("#FF69B4");


    public static final int[] COLORS = new int[]{COLOR_BLUE, COLOR_VIOLET, COLOR_GREEN, COLOR_ORANGE, COLOR_RED, COLOR_6, COLOR_7, COLOR_8, COLOR_9, COLOR_10};
