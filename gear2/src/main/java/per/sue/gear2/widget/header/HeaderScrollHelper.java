package per.sue.gear2.widget.header;
...
public class HeaderScrollHelper {
    ...
    public void setCurrentScrollableContainer(ScrollableContainer scrollableContainer) {
        ...
        mCurrentScrollableContainer = scrollableContainer;
    }
    ...
    public boolean isTop() {
        ...
        }if (scrollableView instanceof FrameLayout){
            return isFrameViewTop((FrameLayout) scrollableView);
        }
    ...
    private boolean isFrameViewTop(FrameLayout scrollView){
        if (scrollView != null) {
            int scrollViewY = scrollView.getScrollY();
            return scrollViewY <= 0;
        }
    ...
    public void smoothScrollBy(int velocityY, int distance, int duration) {
        ...
        if (scrollableView instanceof ListView) {
            AbsListView absListView = (ListView) scrollableView;
            if (sysVersion >= 21) {
