...
* 时 间：2016/5/4
*/
public class OperateEditText extends EditText implements View.OnFocusChangeListener, TextWatcher {
    ...
    private void init() {
        ...
        if (rightDrawable == null && 0 != rightResID) {
            rightDrawable = getResources().getDrawable(rightResID);
        }
