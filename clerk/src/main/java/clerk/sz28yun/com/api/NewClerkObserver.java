 ...
 */
public class NewClerkObserver extends APIObserver {

    private static final String TAG = "ClerkObserver";
    private boolean isParserInRoot;

    public NewClerkObserver(ApiConnection apiConnection, Parser parser) {
        super( apiConnection, parser);
    }

    public NewClerkObserver(ApiConnection apiConnection, Parser parser, boolean isParserInRoot) {
        super( apiConnection, parser);
