 ...
 */
public class CouponMealsItemPresenter extends AbsPresenter {
    private static final String TAG = "LoginPresenter";

    private CouponMealsItemView view;
    private Context context;
    private CouponAPI couponAPI;
    private String token;
    private GoodsAPI goodsAPI;

    public CouponMealsItemPresenter(Context context, CouponMealsItemView view) {
        this.view = view;
    ...
    public interface CouponMealsItemView extends GearResultView<String> {
